...
## [42.0.2](https://github.com/bluealloy/revm/compare/revm-inspector-v42.0.1...revm-inspector-v42.0.2) - 2026-08-12

### Other

- updated the following local packages: revm-database-interface, revm-context, revm-database, revm-handler, revm-interpreter
